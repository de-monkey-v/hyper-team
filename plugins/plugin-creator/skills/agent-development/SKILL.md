...
description: Agent file creation and structure guide. This skill should be used when the user asks to "create an agent", "add an agent", "에이전트 만들어줘", "서브에이전트 작성", or needs guidance on agent configuration.
---
...
### Related Skills
- **[plugin-development](../plugin-development/SKILL.md)** - Plugin structure and organization
- **[skill-development](../skill-development/SKILL.md)** - Skills that agents can use
- **[command-development](../command-development/SKILL.md)** - Commands that launch agents

### Related Agents
- **agent-creator** - Create agent configuration files
- **plugin-validator** - Validate agent files
